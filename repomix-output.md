...
<file path="apps/web/app/api/tx/[txid]/route.js">
import { MempoolService } from '@offline/server-api/src/services/mempool.ts';
import { NextResponse } from 'next/server';
...
<file path="docs/Offline Bitcoin Transfer Wallet — Protocol & Engineering Approach (v0.4).md">
# Offline Bitcoin Transfer Wallet — Protocol & Engineering Approach (v0.4)
...
<file path="apps/web/app/about/page.js">
...
<file path="apps/web/app/api/broadcast/route.js">
...
<file path="apps/web/app/api/node/[...path]/route.js">
import { NextResponse } from 'next/server';
...
<file path="apps/web/app/api/ping/route.js">
export async function GET() {
  return new Response(JSON.stringify({ ok: true }), { status: 200 });
}
</file>

<file path="apps/web/app/api/utxos/[address]/[amount]/route.js">
...
<file path="apps/web/app/signer/page.js">
"use client";
...
<file path="apps/web/app/tools/address/page.js">
"use client";
...
<file path="apps/web/app/layout.js">
import './globals.css';
...
<file path="apps/web/app/page.js">
'use client';
...
<file path="apps/web/components/ModeBadge.jsx">
...
<file path="apps/web/components/QRScanner.jsx">
'use client';
...
<file path="apps/web/public/schemas/claim-bundle.cddl">
; claim-bundle@1
...
<file path="apps/web/public/schemas/utxo-snapshot.cddl">
; utxo-snapshot@1
...
<file path="docs/JSON_PERSISTENCE.md">
...
<file path="packages/offline-core/src/index.js">
...
<file path="packages/offline-core/test/ur.test.js">
...
<file path="packages/offline-core/README.md">
# @offline/core
...
<file path="packages/offline-interop/src/build-witness.js">
...
<file path="packages/offline-interop/src/index.js">
export { parseClaimBundle } from './parse-claim-bundle.js';
export { buildClaimWitness } from './build-witness.js';
</file>

<file path="packages/offline-interop/src/parse-claim-bundle.js">
...
<file path="packages/offline-interop/package.json">
{
...
<file path="scripts/debug-keys.js">
import * as bitcoin from 'bitcoinjs-lib';
import { ECPairFactory } from 'ecpair';
...
<file path="scripts/final-diagnosis.js">
import * as bitcoin from 'bitcoinjs-lib';
import { ECPairFactory } from 'ecpair';
import * as ecc from 'tiny-secp256k1';
...
<file path="scripts/fix-signing-issue.js">
import * as bitcoin from 'bitcoinjs-lib';
import { ECPairFactory } from 'ecpair';
import * as ecc from 'tiny-secp256k1';
...
<file path="scripts/taproot-key-analysis.js">
import * as bitcoin from 'bitcoinjs-lib';
import { ECPairFactory } from 'ecpair';
import * as ecc from 'tiny-secp256k1';
...
<file path="scripts/taproot-signing-test.js">
import * as bitcoin from 'bitcoinjs-lib';
import { ECPairFactory } from 'ecpair';
import * as ecc from 'tiny-secp256k1';
...
<file path="scripts/test-control-block.js">
import * as bitcoin from 'bitcoinjs-lib';
import { ECPairFactory } from 'ecpair';
import * as ecc from 'tiny-secp256k1';
...
<file path="scripts/test-exact-match.js">
import * as bitcoin from 'bitcoinjs-lib';
import { ECPairFactory } from 'ecpair';
import * as ecc from 'tiny-secp256k1';
...
<file path="apps/web/app/watch/page.js">
"use client";
...
<file path="apps/web/public/sw-cold.js">
...
<file path="packages/offline-core/src/psbt.js">
import * as bitcoin from 'bitcoinjs-lib';
import * as ecc from '@bitcoinerlab/secp256k1';
...
<file path="packages/offline-core/test/psbt.test.js">
import { test, expect } from 'vitest';
import * as bitcoin from 'bitcoinjs-lib';
import * as ecc from '@bitcoinerlab/secp256k1';
...
<file path="packages/offline-core/test/taproot.test.js">
import { test, expect } from 'vitest';
import * as bitcoin from 'bitcoinjs-lib';
import * as ecc from '@bitcoinerlab/secp256k1';
import { randomBytes } from 'crypto';
...
<file path="packages/server-api/src/services/mempool.ts">
...
<file path="packages/server-api/src/services/UTXOService.ts">
...
<file path="packages/server-api/package.json">
{
...
<file path="apps/web/app/cold/page.js">
"use client";
...
<file path="apps/web/app/receiver/page.js">
"use client";
...
<file path="packages/offline-core/src/taproot.js">
import * as bitcoin from 'bitcoinjs-lib';
import * as ecc from '@bitcoinerlab/secp256k1';
...
<file path="packages/offline-core/src/ur.js">
...
<file path="packages/offline-core/package.json">
{
  "name": "@offline/core",
  "version": "0.1.0",
  "private": false,
