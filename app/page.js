...
export default function Home() {
  return (
    <main className="space-y-6">
      ...
      <p className="text-zinc-500">Select a mode to begin. Target: Testnet4.</p>
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <Link className="rounded-2xl p-6 border hover:shadow-md" href="/wallets">Wallet Manager</Link>
