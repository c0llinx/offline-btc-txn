...
export default function AddressTool() {
  ...
  return (
    <main className="space-y-6">
      ...
      <div className="text-xs text-zinc-500">Privacy note: deriving a destination from the same private key as R links your claim key and payout. For testnet4/testing this is fine. For production, use a fresh wallet receiving address.</div>
    </main>
  );
}
